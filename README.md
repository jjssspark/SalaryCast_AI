...
5. **국가대표 명단 보강** — 대회 문서에서 명단을 읽던 방식이 대회마다 결과가 달랐습니다. 아시안게임 3개 대회는 문서에 명단이 아예 없어 0명이었고(김형준·나균안 등이 경력 없음으로 처리), 올림픽·프리미어12는 반대로 감독·코치가 섞여 실제 엔트리보다 많았습니다. 위키백과 **참가 선수 분류**에서 읽도록 바꿔 국가대표 기록 287건 → 410건이 됐습니다 (TS-010).
