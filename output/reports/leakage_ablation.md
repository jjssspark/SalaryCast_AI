...
|---|---|---|---|---|
| hitter | v7 방식(누수) | 0.508 | 5.14 | 3.47 |
| hitter | v8 방식(제거) | 0.503 | 5.16 | 3.48 |
| pitcher | v7 방식(누수) | 0.589 | 2.98 | 2.33 |
| pitcher | v8 방식(제거) | 0.586 | 2.99 | 2.33 |

## 최종 선정 모델

| 대상 | 방식 | R2 | RMSE(억) | MAE(억) | 표본 |
|---|---|---|---|---|---|
| hitter | blend:XGBoost+Ridge | 0.541 | 4.96 | 3.40 | 93명 |
| pitcher | blend:LightGBM+Ridge | 0.677 | 2.64 | 2.01 | 46명 |
